...
<body>
  <div class="header">
    <div id="navbar">
  <a class="active" href="javascript:void(0)">Test</a>
  ...
  <a href="javascript:void(0)">Test</a>
                    ...
                    <div class="service-item">
                        <div class="icon">
                            <a href="#" class="scroll-link" data-id="portfolio">
                                <img src="img/Paninda.png" alt="PandA"/>
                            </a>
                        </div>
    ...
    <section id="about2" class="page-section">
        <div class="container">
            <img class="images5" src='img/Engage.png' alt="Panda" />
